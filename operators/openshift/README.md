...
The latest stable release is [3.7.0](https://github.com/nginx/nginx-ingress-helm-operator/releases/tag/v3.7.0). For production use, we recommend that you choose the latest stable release.
