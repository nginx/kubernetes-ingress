...
| `subroutes[].action.redirect.code` | `integer` | The status code of a redirect. The allowed values are: 301, 302, 307 or 308. The default follows the ConfigMap http-redirect-code setting, which defaults to 301. |
...
| `subroutes[].errorPages[].redirect.code` | `integer` | The status code of a redirect. The allowed values are: 301, 302, 307 or 308. The default follows the ConfigMap http-redirect-code setting, which defaults to 301. |
...
| `subroutes[].matches[].action.redirect.code` | `integer` | The status code of a redirect. The allowed values are: 301, 302, 307 or 308. The default follows the ConfigMap http-redirect-code setting, which defaults to 301. |
...
| `subroutes[].matches[].splits[].action.redirect.code` | `integer` | The status code of a redirect. The allowed values are: 301, 302, 307 or 308. The default follows the ConfigMap http-redirect-code setting, which defaults to 301. |
...
| `subroutes[].splits[].action.redirect.code` | `integer` | The status code of a redirect. The allowed values are: 301, 302, 307 or 308. The default follows the ConfigMap http-redirect-code setting, which defaults to 301. |
