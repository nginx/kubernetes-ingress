	...
	tests := []struct {
		...
		},
		{
			...
			expected: policiesCfg{
				Context: ctx,
				OIDCProvider: &version2.OIDCProvider{
					Name:          "oidc_default_oidc_native_full_default_test",
					...
					FrontChannelLogoutURI: "/frontchannel_logout",
					LogoutTokenHint:       true,
					SessionStore:          "oidc_sessions_oidc_default_oidc_native_full_default_test",
					SessionTimeout:        "8h",
					UserInfoEnable:        true,
					...
					SSLName:               "custom-sni.example.com",
					SSLVerifyDepth:        3,
					ProxyLocation:         "/_oidc_idp_oidc_default_oidc_native_full_default_test",
					ProxyBufferSize:       "16k",
		...
		},
		{
			...
			expected: policiesCfg{
				...
				OIDCProvider: &version2.OIDCProvider{
					...
					SessionStore:    "oidc_sessions_oidc_default_oidc_native_1_default_test",
					SSLVerify:       true,
					SSLName:         "accounts.google.com",
					SSLVerifyDepth:  1,
					ProxyLocation:   "/_oidc_idp_oidc_default_oidc_native_1_default_test",
					ProxyBufferSize: "32k",
				},
			},
			expectedWarnings: Warnings{
