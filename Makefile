...
override DOCKER_BUILD_OPTIONS += --build-arg IC_VERSION=$(VERSION) --build-arg PLUS_REPO=$(PLUS_REPO) --build-arg OSS_REPO=$(OSS_REPO) ## The options for the docker build command. For example, --pull
