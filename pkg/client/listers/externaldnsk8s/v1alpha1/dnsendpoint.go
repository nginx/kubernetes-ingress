...
type DNSEndpointLister interface {
	...
	List(selector labels.Selector) (ret []*externaldnsk8sv1alpha1.DNSEndpoint, err error)
...
type dNSEndpointLister struct {
	listers.ResourceIndexer[*externaldnsk8sv1alpha1.DNSEndpoint]
}

// NewDNSEndpointLister returns a new DNSEndpointLister.
func NewDNSEndpointLister(indexer cache.Indexer) DNSEndpointLister {
	return &dNSEndpointLister{listers.New[*externaldnsk8sv1alpha1.DNSEndpoint](indexer, externaldnsk8sv1alpha1.Resource("dnsendpoint"))}
}

// DNSEndpoints returns an object that can list and get DNSEndpoints.
func (s *dNSEndpointLister) DNSEndpoints(namespace string) DNSEndpointNamespaceLister {
	return dNSEndpointNamespaceLister{listers.NewNamespaced[*externaldnsk8sv1alpha1.DNSEndpoint](s.ResourceIndexer, namespace)}
}
...
type DNSEndpointNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*externaldnsk8sv1alpha1.DNSEndpoint, error)
