...
type Upstream struct {
	...
	Keepalive *int `json:"keepalive"` // +kubebuilder:validation:Optional
	// +kubebuilder:validation:Enum="1.0";"1.1";"2"
	// Sets the HTTP protocol version used for connections to the upstream servers.
	// Supported values are "1.0", "1.1" and "2.0". If unset, the appProtocol of the
	// backing Service is used ("kubernetes.io/h2c" implies "2"), otherwise "1.1".
	// Note: "2" is ignored for upstreams with type "grpc". Requires NGINX 1.29.4+.
