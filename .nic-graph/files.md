...
- [internal/certmanager/cm_controller_test.go](../internal/certmanager/cm_controller_test.go) — Test_controller_Register
- [internal/certmanager/helper.go](../internal/certmanager/helper.go)
- [internal/certmanager/helper_test.go](../internal/certmanager/helper_test.go) — Test_translateVsSpec
- [internal/certmanager/sync.go](../internal/certmanager/sync.go) — SyncFn, SyncFnFor
- [internal/certmanager/sync_test.go](../internal/certmanager/sync_test.go) — TestIssuerForVirtualServer, TestSync, Test_findCertificatesToBeRemoved
...
- [internal/configs/annotations_test.go](../internal/configs/annotations_test.go) — BenchmarkFilterMasterAnnotations, BenchmarkFilterMinionAnnotations, BenchmarkMergeMasterAnnotationsIntoMinion, BenchmarkParseRewrites, BenchmarkParseRewritesWithLeadingAndTrailingWhitespace, BenchmarkParseStickyService, TestAppRootAnnotation, TestClientBodyBufferSizeAnnotationInvalid, TestClientBodyBufferSizeAnnotationValid, TestFilterMasterAnnotations, TestFilterMinionAnnotations, TestGetRewriteTarget, …
...
- [internal/configs/config_params_test.go](../internal/configs/config_params_test.go) — TestNewDefaultConfigParamsUpstreamZoneSize
...
- [internal/configs/configmaps_test.go](../internal/configs/configmaps_test.go) — TestOpenTelemetryConfigurationInvalid, TestOpenTelemetryConfigurationSuccess, TestParseAndValidateAddHeaders, TestParseConfigMapAccessLog, TestParseConfigMapAccessLogDefault, TestParseConfigMapAddHeader, TestParseConfigMapClientBodyBufferSizeInvalid, TestParseConfigMapClientBodyBufferSizeValid, TestParseConfigMapOIDC, TestParseConfigMapOIDCErrors, TestParseConfigMapWithAddHeaderInherit, TestParseConfigMapWithAppProtectCompressedRequestsAction, …
...
- [internal/configs/configurator_bench_test.go](../internal/configs/configurator_bench_test.go) — BenchUpdateEndpoints, BenchmarkAddOrUpdateIngress, BenchmarkAddOrUpdateMergeableIngress, BenchmarkAddTransportServerMetricsLabels, BenchmarkAddVirtualServerMetricsLabels, BenchmarkUpdateEndpointsMergeableIngress
- [internal/configs/configurator_test.go](../internal/configs/configurator_test.go) — (errorOnDefaultServerCreateManager).CreateConfig, (mockLabelUpdater).DeleteCacheZoneLabels, (mockLabelUpdater).DeleteServerZoneLabels, (mockLabelUpdater).DeleteStreamServerZoneLabels, (mockLabelUpdater).DeleteStreamUpstreamServerLabels, (mockLabelUpdater).DeleteStreamUpstreamServerPeerLabels, (mockLabelUpdater).DeleteUpstreamServerLabels, (mockLabelUpdater).DeleteUpstreamServerPeerLabels, (mockLabelUpdater).DeleteWorkerLabels, (mockLabelUpdater).UpdateCacheZoneLabels, (mockLabelUpdater).UpdateServerZoneLabels, (mockLabelUpdater).UpdateStreamServerZoneLabels, …
- [internal/configs/dos.go](../internal/configs/dos.go)
- [internal/configs/dos_test.go](../internal/configs/dos_test.go) — TestUpdateApDosResource
...
- [internal/configs/ingress_test.go](../internal/configs/ingress_test.go) — TestAddSSLConfig, TestCreateExternalAuthUpstream, TestFilterIngressPolicyRefs, TestGenerateIngressExternalAuthLocation, TestGenerateIngressExternalAuthOAuth2Location, TestGenerateIngressPath, TestGenerateJWTConfig, TestGenerateNginxCfg, TestGenerateNginxCfgAppliesWAFAndCORSFromDifferentPolicyAnnotations, TestGenerateNginxCfgForAccessControl, TestGenerateNginxCfgForAddHeaderInherit, TestGenerateNginxCfgForAppProtect, …
...
- [internal/configs/parsing_helpers_test.go](../internal/configs/parsing_helpers_test.go) — TestGetMapKeyAsBool, TestGetMapKeyAsBoolErrorMessage, TestGetMapKeyAsBoolNotFound, TestGetMapKeyAsInt, TestGetMapKeyAsInt64, TestGetMapKeyAsInt64ErrorMessage, TestGetMapKeyAsInt64NotFound, TestGetMapKeyAsIntErrorMessage, TestGetMapKeyAsIntNotFound, TestGetMapKeyAsStringSlice, TestGetMapKeyAsStringSliceMultilineSnippets, TestGetMapKeyAsStringSliceNotFound, …
- [internal/configs/policy.go](../internal/configs/policy.go) — DefaultSigninRedirectBasePath, IsPolicySupportedOnIngress
- [internal/configs/policy_test.go](../internal/configs/policy_test.go) — TestAddCORSConfig, TestAddExternalAuthConfig, TestAddWafConfig, TestGenerateCORSPolicy, TestGenerateExternalAuthPolicy, TestGenerateLRZGroupMaps, TestGenerateLRZPolicyGroupMap, TestGeneratePolicies, TestGeneratePoliciesFails, TestGeneratePolicies_GeneratesWAFPolicyOnValidApBundle, TestGeneratePolicies_UnsupportedOnIngress, TestIsPolicySupportedOnIngress, …
- [internal/configs/transportserver.go](../internal/configs/transportserver.go) — (TransportServerEx).String, TransportServerEx
- [internal/configs/transportserver_test.go](../internal/configs/transportserver_test.go) — TestGenerateHealthCheckMatch, TestGenerateTransportServerConfigForBackupServiceNGINXPlus, TestGenerateTransportServerConfigForIPV6Disabled, TestGenerateTransportServerConfigForTCP, TestGenerateTransportServerConfigForTCPMaxConnections, TestGenerateTransportServerConfigForTCPSnippets, TestGenerateTransportServerConfigForTCPWithTLS, TestGenerateTransportServerConfigForTCPWithTLSWithHost, TestGenerateTransportServerConfigForTLSPassthrough, TestGenerateTransportServerConfigForUDP, TestGenerateTransportServerConfig_DoesNotGenerateBackupOnMissingBackupName, TestGenerateTransportServerConfig_DoesNotGenerateBackupOnMissingBackupPort, …
...
- [internal/configs/virtualserver_config_test.go](../internal/configs/virtualserver_config_test.go) — TestGenerateVSConfigWithHeaderInherit, TestGenerateVSConfig_GeneratesConfigWithGunzipOff, TestGenerateVSConfig_GeneratesConfigWithGunzipOn, TestGenerateVSConfig_GeneratesConfigWithNoGunzip, TestGenerateVirtualServerConfig, TestGenerateVirtualServerConfigGrpcErrorPageWarning, TestGenerateVirtualServerConfigIPV6Disabled, TestGenerateVirtualServerConfigWithBackupForNGINXPlus, TestGenerateVirtualServerConfigWithCustomHttpAndHttpsIPListeners, TestGenerateVirtualServerConfigWithCustomHttpAndHttpsListeners, TestGenerateVirtualServerConfigWithCustomHttpIPListener, TestGenerateVirtualServerConfigWithCustomHttpListener, …
- [internal/configs/virtualserver_helpers_test.go](../internal/configs/virtualserver_helpers_test.go) — TestAddPoliciesCfgToLocations, TestCreateEndpointsFromUpstream, TestCreateUpstreamServersConfigForPlus, TestCreateUpstreamServersConfigForPlusNoUpstreams, TestCreateUpstreamsForPlus, TestGenerateAuthJwtClaimSetClaim, TestGenerateAuthJwtClaimSetVariable, TestGenerateBuffer, TestGenerateEndpointsForUpstream, TestGenerateEndpointsKey, TestGenerateErrorPageCodes, TestGenerateErrorPageDetails, …
- [internal/configs/virtualserver_policy_test.go](../internal/configs/virtualserver_policy_test.go) — TestGenerateExternalAuthLocation, TestGenerateExternalAuthOAuth2Location, TestGenerateVirtualServerConfigAPIKeyClientMaps, TestGenerateVirtualServerConfigAPIKeyPolicy, TestGenerateVirtualServerConfigCache, TestGenerateVirtualServerConfigExternalAuthMultipleRoutesNoDuplicateOAuth2, TestGenerateVirtualServerConfigExternalAuthPolicy, TestGenerateVirtualServerConfigExternalAuthPolicyPlusRoute, TestGenerateVirtualServerConfigExternalAuthPolicyPlusSubroute, TestGenerateVirtualServerConfigJWKSPolicy, TestGenerateVirtualServerConfigJWTSSLVerifyDepth, TestGenerateVirtualServerConfigOIDCAtSpecLevelAppliesToAllRoutes, …
- [internal/configs/virtualserver_ratelimit_groups_test.go](../internal/configs/virtualserver_ratelimit_groups_test.go) — TestGenerateVirtualServerConfigRateLimitGroups, TestGenerateVirtualServerConfigWithRateLimitGroupsWarning
- [internal/configs/virtualserver_routing_test.go](../internal/configs/virtualserver_routing_test.go) — TestGenerateDefaultSplitsConfig, TestGenerateMatchesConfig, TestGenerateMatchesConfigWithMultipleSplits, TestGenerateParametersForMatchesRouteMap, TestGenerateSplits, TestGenerateSplitsWeightChangesDynamicReload, TestGenerateValueForMatchesRouteMap, TestGenerateVirtualServerConfigForVSRWithMultipleRegexSubroutes, TestGenerateVirtualServerConfigForVirtualServerRoutesWithDos, TestGenerateVirtualServerConfigForVirtualServerWithMatches, TestGenerateVirtualServerConfigForVirtualServerWithReturns, TestGenerateVirtualServerConfigForVirtualServerWithSplits, …
...
- [internal/configs/commonhelpers/common_template_helpers_test.go](../internal/configs/commonhelpers/common_template_helpers_test.go) — TestMakeSecretPath
...
- [internal/configs/version1/header_parsing_helper_test.go](../internal/configs/version1/header_parsing_helper_test.go) — TestMergeProxySetHeaders, TestParseAddHeaders, TestParseProxySetHeaders, TestValidateAddHeaderName, TestValidateAddHeaderValue
...
- [internal/configs/version1/template_executor_test.go](../internal/configs/version1/template_executor_test.go) — TestNewTemplateExecutor, TestTemplateExecutorUsesOriginalIngressTemplate, TestTemplateExecutorUsesOriginalMainTemplate
- [internal/configs/version1/template_helper.go](../internal/configs/version1/template_helper.go)
- [internal/configs/version1/template_helper_test.go](../internal/configs/version1/template_helper_test.go) — TestContainsSubstring, TestHasPrefix, TestHasSuffix, TestMakeLocationPath_ForIngress, TestMakeLocationPath_ForIngressWithPathRegexCaseSensitive, TestMakeLocationPath_ForIngressWithPathRegexSetOnMaster, TestMakeLocationPath_ForIngressWithPathRegexSetOnMinion, TestMakeLocationPath_ForIngressWithoutPathRegex, TestMakeLocationPath_PathRegexSetOnMasterDoesNotModifyMinionWithoutPathRegexAnnotation, TestMakeLocationPath_SetOnMinionTakesPrecedenceOverMaster, TestMakeLocationPath_WithBogusAnnotationName, TestMakeLocationPath_WithBogusRegexModifier, …
- [internal/configs/version1/template_test.go](../internal/configs/version1/template_test.go) — TestExecuteMainTemplateForNGINX, TestExecuteMainTemplateForNGINXPlus, TestExecuteMainTemplateForNGINXPlusMGMTProxyHost, TestExecuteMainTemplateForNGINXPlusMGMTProxyUser, TestExecuteMainTemplateForNGINXPlusMGMTProxyUserAndPass, TestExecuteMainTemplateWithAddHeaders, TestExecuteTemplate_FailsOnBogusIngressTemplatePath, TestExecuteTemplate_FailsOnBogusMainTemplatePath, TestExecuteTemplate_ForDefaultServerForNGINXPlusWithCustomDefaultHTTPAndHTTPSListenerPorts, TestExecuteTemplate_ForDefaultServerForNGINXPlusWithCustomDefaultHTTPListenerPort, TestExecuteTemplate_ForDefaultServerForNGINXPlusWithCustomDefaultHTTPSListenerPort, TestExecuteTemplate_ForDefaultServerForNGINXPlusWithHTTP2Off, …
- [internal/configs/version1/template_waf_policy_test.go](../internal/configs/version1/template_waf_policy_test.go) — TestExecuteTemplate_ForIngressForNGINXPlusWithLocationWAFBundle, TestExecuteTemplate_ForIngressForNGINXPlusWithServerWAFPolicy
...
- [internal/configs/version2/template_executor_test.go](../internal/configs/version2/template_executor_test.go) — TestTemplateExecutorUsesOriginalTStemplate, TestTemplateExecutorUsesOriginalVStemplate
- [internal/configs/version2/template_helper.go](../internal/configs/version2/template_helper.go)
- [internal/configs/version2/template_helper_test.go](../internal/configs/version2/template_helper_test.go) — TestBoolToInt, TestContainsSubstring, TestHasPrefix, TestHasSuffix, TestMakeHTTPListener, TestMakeHTTPListenerAndHTTPSListenerWithCustomIPs, TestMakeHTTPListenerWithCustomIPV4, TestMakeHTTPListenerWithCustomIPV6, TestMakeHTTPSListener, TestMakeHTTPSListenerWithCustomIPV4, TestMakeHTTPSListenerWithCustomIPV6, TestMakeHeaderQueryValue, …
- [internal/configs/version2/templates_test.go](../internal/configs/version2/templates_test.go) — TestExecuteTemplateForNGINXOSSTransportServerWithSNI, TestExecuteTemplateForNGINXPlusTransportServerWithSNI, TestExecuteTemplateForTransportServerWithBackupServerForNGINXPlus, TestExecuteTemplateForTransportServerWithResolver, TestExecuteTemplateForTransportServerWithTCPIPListener, TestExecuteTemplateForTransportServerWithUDPIPListener, TestExecuteVirtualServerTemplateWithAPIKeyPolicyNGINXPlus, TestExecuteVirtualServerTemplateWithBackupServerNGINXPlus, TestExecuteVirtualServerTemplateWithCachePolicyNGINXPlus, TestExecuteVirtualServerTemplateWithCachePolicyOSS, TestExecuteVirtualServerTemplateWithExtendedCachePolicy, TestExecuteVirtualServerTemplateWithJWKSWithToken, …
...
- [internal/externaldns/controller_test.go](../internal/externaldns/controller_test.go) — TestNewController_DynamicNsSkipsEmptyNamespace, TestNewController_NoNamespaces, TestNewController_WithNamespace
...
- [internal/externaldns/sync_test.go](../internal/externaldns/sync_test.go) — (DNSEPLister).DNSEndpoints, (DNSEPLister).List, (DNSEPNamespaceLister).Get, (DNSEPNamespaceLister).List, (EventRecorder).AnnotatedEventf, (EventRecorder).Event, (EventRecorder).Eventf, DNSEPLister, DNSEPListerExpansion, DNSEPNamespaceLister, EventRecorder, TestGetValidTargets, …
...
## github.com/nginx/kubernetes-ingress/internal/healthcheck_test

- [internal/healthcheck/healthcheck_test.go](../internal/healthcheck/healthcheck_test.go) — TestHealthCheckServer_RespondsWith404OnNotExistingHostname, TestHealthCheckServer_RespondsWith500OnErrorFromNGINXAPI, TestHealthCheckServer_Returns404OnBogusTransportServerActionName, TestHealthCheckServer_Returns404OnMissingHostname, TestHealthCheckServer_Returns404OnMissingTransportServerActionName, TestHealthCheckServer_ReturnsCorrectStatsForHostnameOnAllPeersDown, TestHealthCheckServer_ReturnsCorrectStatsForHostnameOnAllPeersUp, TestHealthCheckServer_ReturnsCorrectStatsForValidHostnameOnPartOfPeersDown, TestHealthCheckServer_ReturnsCorrectTransportServerStatsForNameOnAllPeersDown, TestHealthCheckServer_ReturnsCorrectTransportServerStatsForNameOnAllPeersUp, TestHealthCheckServer_ReturnsCorrectTransportServerStatsForNameOnSomePeersUpSomeDown
...
- [internal/k8s/appprotect_waf_test.go](../internal/k8s/appprotect_waf_test.go) — TestAddWAFPolicyRefs, TestGetWAFPoliciesForAppProtectLogConf, TestGetWAFPoliciesForAppProtectPolicy
...
- [internal/k8s/configuration_test.go](../internal/k8s/configuration_test.go) — (testReferenceChecker).IsReferencedByIngress, (testReferenceChecker).IsReferencedByMinion, (testReferenceChecker).IsReferencedByTransportServer, (testReferenceChecker).IsReferencedByVirtualServer, (testReferenceChecker).IsReferencedByVirtualServerRoute, TestAddGlobalConfigurationThenAddVirtualServerWithValidCustomListeners, TestAddIngressDuringStartup_ReturnsNoChanges, TestAddIngressEmptyHostAcceptedWhenEnabled, TestAddIngressEmptyHostOldestWinsAndPromotesOnDelete, TestAddIngressForMergeableIngresses, TestAddIngressForRegularIngress, TestAddIngressWithIncorrectClass, …
...
- [internal/k8s/controller_test.go](../internal/k8s/controller_test.go) — (fakeStore).Bookmark, (fakeStore).LastStoreSyncResourceVersion, (testNginxManager).CreateConfig, (testResource).AcquireHost, (testResource).AddWarning, (testResource).GetKeyWithKind, (testResource).GetObjectMeta, (testResource).IsEqual, (testResource).IsSame, (testResource).ReleaseHost, (testResource).String, (testResource).Wins, …
...
- [internal/k8s/handlers_test.go](../internal/k8s/handlers_test.go) — TestAreResourcesDifferent
...
- [internal/k8s/namespaced_informer_test.go](../internal/k8s/namespaced_informer_test.go) — TestAddAppProtectHandlers_AppProtectDosEnabled, TestAddAppProtectHandlers_AppProtectEnabled, TestAddAppProtectHandlers_BothEnabled, TestAddAppProtectHandlers_Disabled, TestAddCustomResourceHandlers_Disabled, TestAddCustomResourceHandlers_Enabled
...
- [internal/k8s/reference_checkers_test.go](../internal/k8s/reference_checkers_test.go) — TestAppProtectResourceIsReferenced, TestAppProtectResourceIsReferencedByIngresses, TestBackupServiceIsReferencedByTransportServer, TestBackupServiceIsReferencedByVirtualServer, TestDosProtectedIsReferencedByIngresses, TestDosProtectedIsReferencedByVirtualServer, TestEndpointIsReferencedByVirtualServerAndVirtualServerRoutes, TestExternalAuthServiceIsReferencedByVirtualServer, TestExternalAuthServiceIsReferencedByVirtualServerRoute, TestIsPolicyIsReferenced, TestPolicyIsReferencedByIngress, TestPolicyIsReferencedByMinion, …
- [internal/k8s/service.go](../internal/k8s/service.go) — (portSort).Len, (portSort).Less, (portSort).Swap
- [internal/k8s/service_test.go](../internal/k8s/service_test.go) — TestHasServicePortChanges
...
- [internal/k8s/status_test.go](../internal/k8s/status_test.go) — TestGenerateExternalEndpointsFromStatus, TestGetExternalServicePorts, TestHasPolicyStatusChanged, TestHasVsStatusChanged, TestHasVsrStatusChanged, TestIsRequiredPort, TestStatusUpdateWithExternalStatusAndExternalService, TestStatusUpdateWithExternalStatusAndIngressLink, TestUpdateTransportServerStatus, TestUpdateTransportServerStatusIgnoreNoChange, TestUpdateTransportServerStatusMissingTransportServer
...
- [internal/k8s/validation_test.go](../internal/k8s/validation_test.go) — TestGetSpecServices, TestValidateAddHeaderAnnotation, TestValidateCurlyBraces, TestValidateIllegalKeywords, TestValidateIngress, TestValidateIngressSpec, TestValidateIngress_WithInvalidPathRegexValuesForNGINX, TestValidateIngress_WithInvalidPathRegexValuesForNGINXPlus, TestValidateIngress_WithValidPathRegexValuesForNGINX, TestValidateIngress_WithValidPathRegexValuesForNGINXPlus, TestValidateMasterSpec, TestValidateMinionSpec, …
...
- [internal/k8s/appprotect/app_protect_configuration_test.go](../internal/k8s/appprotect/app_protect_configuration_test.go) — TestAddOrUpdateLogConf, TestAddOrUpdatePolicy, TestAddOrUpdateUserSig, TestCreateAppProtectLogConfEx, TestCreateAppProtectPolicyEx, TestCreateAppProtectUserSigEx, TestDeleteLogConf, TestDeletePolicy, TestDeleteUserSig, TestGetAppProtectResource, TestIsReqSatisfiedByUserSig
...
- [internal/k8s/appprotectcommon/app_protect_common_resources_test.go](../internal/k8s/appprotectcommon/app_protect_common_resources_test.go) — TestGenNsName, TestParseResourceReferenceAnnotation, TestParseResourceReferenceAnnotationList
...
- [internal/k8s/appprotectdos/app_protect_dos_configuration_test.go](../internal/k8s/appprotectdos/app_protect_dos_configuration_test.go) — TestAddOrUpdateDosLogConf, TestAddOrUpdateDosPolicy, TestAddOrUpdateDosProtected, TestCreateAppProtectDosLogConfEx, TestCreateAppProtectDosPolicyEx, TestDeleteDosLogConf, TestDeleteDosProtected, TestDeletePolicy, TestGetDosEx, TestGetDosExDosDisabled, TestGetDosProtected, TestGetDosProtectedThatReferencedDosLogConf, …
...
- [internal/k8s/secrets/store_test.go](../internal/k8s/secrets/store_test.go) — (fakeSecretFileManager).AddOrUpdateSecret, (fakeSecretFileManager).DeleteSecret, (fakeSecretFileManager).Reset, TestAddOrUpdateSecret, TestDeleteSecretInvalidSecret, TestDeleteSecretNonExisting, TestDeleteSecretValidSecret, TestGetSecretReferenceMapAddSecret
...
- [internal/k8s/secrets/validation_test.go](../internal/k8s/secrets/validation_test.go) — TestHasCorrectSecretType, TestValidateCASecret, TestValidateCASecretFails, TestValidateHtpasswdSecret, TestValidateHtpasswdSecretFails, TestValidateJWKSecret, TestValidateJWKSecretFails, TestValidateLicenseSecret, TestValidateLicenseSecretFails, TestValidateOIDCSecret, TestValidateOIDCSecretFails, TestValidateSecret, …
...
- [internal/license_reporting/license_reporting_test.go](../internal/license_reporting/license_reporting_test.go) — TestLicenseExpiring, TestNewLicenseInfo, TestNewLicenseReporter, TestUsageGraceEnding, TestWriteLicenseInfo
...
- [internal/logger/glog/handler_test.go](../internal/logger/glog/handler_test.go) — TestGlogDefaultLevel, TestGlogFormat, TestGlogHigherLevel, TestGlogLogLevels
...
- [internal/metadata/metadata_test.go](../internal/metadata/metadata_test.go) — TestCollectAndWrite, TestNewMetadataInfo, TestNewMetadataReporter
...
- [internal/metrics/collectors/latency_test.go](../internal/metrics/collectors/latency_test.go) — TestCreateLatencyLabelNames, TestCreateLatencyLabelNamesWithNilInputs, TestCreateLatencyLabelValuesWithCorrectNumberOfLabels, TestCreateLatencyLabelValuesWithNoLabels, TestCreateLatencyLabelValuesWithNoUpstreamPeerServerLabels, TestCreateLatencyLabelValuesWithNoUpstreamServerLabels, TestMetricsPublished, TestParseMessageWithValidInputs
...
- [internal/nginx/manager_test.go](../internal/nginx/manager_test.go) — TestFormatUpdateServersInPlusLog, TestGetOSCABundlePath
...
- [internal/nginx/verify_test.go](../internal/nginx/verify_test.go) — (Transport).RoundTrip, TestConfigWriter, TestVerifyClient, Transport
...
## github.com/nginx/kubernetes-ingress/internal/nginx_test

- [internal/nginx/version_test.go](../internal/nginx/version_test.go) — TestExtractAgentVersionValues, TestNginxNewVersionHandlesRawString, TestNginxVersionFormat, TestNginxVersionParsing, TestNginxVersionPlusGreaterThanOrEqualTo, TestNginxVersionPlusGreaterThanOrEqualToFailsOnInalidInput
...
- [internal/nsutils/utils_test.go](../internal/nsutils/utils_test.go) — TestHasNamespace
...
## github.com/nginx/kubernetes-ingress/internal/telemetry_test

- [internal/telemetry/cluster_test.go](../internal/telemetry/cluster_test.go) — TestAWSPlatformDeterminesOwnName, TestAlibabaPlatformDeterminesOwnName, TestAzurePlatformDeterminesOwnName, TestCloudStackPlatformDeterminesOwnName, TestClusterIDErrorsOnNotExistingService, TestClusterIDRetrievesK8sClusterUID, TestConfigMapKeys, TestDigitalOceanPlatformDeterminesOwnName, TestEquinixMetallPlatformDeterminesOwnName, TestGCPPlatformDeterminesOwnName, TestGetInstallationFlags, TestGetServices, …
- [internal/telemetry/collector_test.go](../internal/telemetry/collector_test.go) — TestAppRootAnnotationTelemetry, TestCollectAppProtectVersion, TestCollectBuildOS, TestCollectClusterIDInClusterWithOneNode, TestCollectClusterVersion, TestCollectConfigMapKeys, TestCollectGetInvalidServices, TestCollectGetServices, TestCollectInstallationFlags, TestCollectInvalidAppProtectVersion, TestCollectInvalidIsPlus, TestCollectIsPlus, …
...
- [internal/validation/data_types_test.go](../internal/validation/data_types_test.go) — TestBalanceProxiesForUpstreams, TestBalanceProxyValues, TestNewNumberSizeConfig, TestNewSizeWithUnit
...
- [internal/validation/validation_test.go](../internal/validation/validation_test.go) — TestValidateHost, TestValidatePort_ErrorsOnInvalidRange, TestValidatePort_IsValidOnValidInput, TestValidateURI, TestValidateUnprivilegedPort_ErrorsOnInvalidRange, TestValidateUnprivilegedPort_IsValidOnValidInput
...
- [pkg/apis/configuration/validation/appprotect_common_test.go](../pkg/apis/configuration/validation/appprotect_common_test.go) — TestValidateAppProtectLogDestinationAnnotation, TestValidateRequiredFields, TestValidateRequiredSlices
- [pkg/apis/configuration/validation/appprotect_test.go](../pkg/apis/configuration/validation/appprotect_test.go) — TestCheckForExtRefs, TestValidateAppProtectLogConf, TestValidateAppProtectPolicy, TestValidateAppProtectUserSig
...
- [pkg/apis/configuration/validation/common_test.go](../pkg/apis/configuration/validation/common_test.go) — TestHeaderValidation, TestParseSpecialVariable, TestParseSpecialVariableFails, TestValidateOffset, TestValidatePath, TestValidateSize, TestValidateSpecialVariable, TestValidateSpecialVariableFails, TestValidateSpecialVariableForPlus, TestValidateSpecialVariableForPlusFails, TestValidateStringWithVariables, TestValidateStringWithVariablesFail, …
...
- [pkg/apis/configuration/validation/globalconfiguration_test.go](../pkg/apis/configuration/validation/globalconfiguration_test.go) — TestGeneratePortProtocolKey, TestValidateGlobalConfiguration, TestValidateListener, TestValidateListenerFails, TestValidateListenerPort, TestValidateListenerProtocol_FailsOnHttpListenerUsingSamePortAsTCP, TestValidateListenerProtocol_FailsOnHttpListenerUsingSamePortAsTCPListener, TestValidateListenerProtocol_FailsOnInvalidInput, TestValidateListenerProtocol_FailsOnTCPListenerUsingSamePortAsHTTPListener, TestValidateListenerProtocol_PassesOnHttpListenerUsingDiffPortToTCPAndUDPListenerWithHTTPDefinedFirst, TestValidateListenerProtocol_PassesOnHttpListenerUsingDiffPortToTCPAndUDPListenerWithTCPAndUDPDefinedFirst, TestValidateListenerProtocol_PassesOnHttpListenerUsingSamePortAsUDPListener, …
- [pkg/apis/configuration/validation/policy.go](../pkg/apis/configuration/validation/policy.go) — PolicyValidationConfig, ValidatePolicy
- [pkg/apis/configuration/validation/policy_test.go](../pkg/apis/configuration/validation/policy_test.go) — TestCORSMDNCompliance, TestValidateAPIKeyPolicy_FailsOnInvalidInput, TestValidateAPIKeyPolicy_PassOnValidInput, TestValidateAccessControl_FailsOnInvalidInput, TestValidateAccessControl_PassesOnValidInput, TestValidateBasic_FailsOnMissingSecret, TestValidateBasic_PassesOnNotEmptySecret, TestValidateCORS, TestValidateClientID, TestValidateClientID_FailsOnInvalidInput, TestValidateEgressMTLS_FailsOnInvalidInput, TestValidateEgressMTLS_PassesOnValidInput, …
...
- [pkg/apis/configuration/validation/transportserver_test.go](../pkg/apis/configuration/validation/transportserver_test.go) — TestValidateHexString, TestValidateHexString_FailsOnInvalidInput, TestValidateIsPotentialTLSPassthroughListener, TestValidateListenerProtocol, TestValidateMatchExpect, TestValidateMatchExpect_FailsOnInvalidInput, TestValidateMatchSend, TestValidateMatchSend_FailsOnInvalidInput, TestValidateSessionParameters, TestValidateSessionParameters_FailsOnInvalidInput, TestValidateTSUpstreamHealthChecks, TestValidateTSUpstreamHealthChecks_FailsOnInvalidInput, …
...
- [pkg/apis/configuration/validation/virtualserver_test.go](../pkg/apis/configuration/validation/virtualserver_test.go) — TestCaptureVariables, TestErrorPageHasRequiredFields, TestIsArgumentName, TestIsCookieName_ErrorsOnInvalidInput, TestIsCookieName_IsValidOnValidInput, TestIsValidMatchValue, TestNormalizePath, TestRejectPlusResourcesInOSS, TestValidateAction, TestValidateActionFails, TestValidateActionProxy, TestValidateActionProxyFails, …
...
- [pkg/apis/dos/validation/dos_test.go](../pkg/apis/dos/validation/dos_test.go) — TestIsValidIPWithMask, TestValidateAppProtectDosAccessLogDest, TestValidateAppProtectDosAllowList, TestValidateAppProtectDosLogConf, TestValidateAppProtectDosLogDest_ValidOnDestinationStdErr, TestValidateAppProtectDosMonitor, TestValidateAppProtectDosName, TestValidateAppProtectDosPolicy, TestValidateDosProtectedResource
...
## github.com/nginx/kubernetes-ingress/pkg/apis/externaldns/validation_test

- [pkg/apis/externaldns/validation/externaldns_test.go](../pkg/apis/externaldns/validation/externaldns_test.go) — TestValidateDNSEndpoint, TestValidateDNSEndpoint_ReturnsErrorOn
